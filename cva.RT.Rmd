...
### Subsample: correct-responses only

Here are the RT summary statistics based only on the correct responses (dropping responses that were incorrect).  

```{r corr.resps.only, echo=FALSE, message =FALSE, fig.asp = 0.85, fig.width = 7, out.width = "98%"}
