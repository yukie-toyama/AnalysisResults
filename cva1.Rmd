...
In the discriminator analysis, students were divided into four groups based on their total scores. The proportion of students in each group choosing a particular answer choice are shown in the last four columns.

We expect that the majority of upper group is choosing the correct option. If a different option is more attractive to the upper group, the item and its options should be flagged for review. For item 45 (decorated word = **quotation**), the answer choices "example" and "symbol"are more attractive to all four groups. 
